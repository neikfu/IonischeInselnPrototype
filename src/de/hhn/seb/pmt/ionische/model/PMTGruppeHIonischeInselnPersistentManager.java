...
public class PMTGruppeHIonischeInselnPersistentManager extends PersistentManager {
	private static final String PROJECT_NAME = "PMTGruppeHIonischeInseln";
	...
	private PMTGruppeHIonischeInselnPersistentManager() throws PersistentException {
	...
	protected void configureMetadataSources(MetadataSources aMetadataSources) {
		...
		aMetadataSources.addAnnotatedClass(de.hhn.seb.pmt.ionische.model.PublicService.class);
		aMetadataSources.addAnnotatedClass(de.hhn.seb.pmt.ionische.model.DangerousEntity.class);
		aMetadataSources.addAnnotatedClass(de.hhn.seb.pmt.ionische.model.RegisteredUser.class);
		aMetadataSources.addAnnotatedClass(de.hhn.seb.pmt.ionische.model.MapElement.class);
		aMetadataSources.addAnnotatedClass(de.hhn.seb.pmt.ionische.model.Review.class);
		aMetadataSources.addAnnotatedClass(de.hhn.seb.pmt.ionische.model.MapModificationRequest.class);
		aMetadataSources.addAnnotatedClass(de.hhn.seb.pmt.ionische.model.Sight.class);
		aMetadataSources.addAnnotatedClass(de.hhn.seb.pmt.ionische.model.Restaurant.class);
		aMetadataSources.addAnnotatedClass(de.hhn.seb.pmt.ionische.model.BoatGasStation.class);
		aMetadataSources.addAnnotatedClass(de.hhn.seb.pmt.ionische.model.Store.class);
		aMetadataSources.addAnnotatedClass(de.hhn.seb.pmt.ionische.model.BoatMooringSpot.class);
	}
	...
	public static synchronized final PersistentManager instance() throws PersistentException {
		if (_instance == null) {
			_instance = new PMTGruppeHIonischeInselnPersistentManager();
		}
